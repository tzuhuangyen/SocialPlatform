  ...
  return (
    <>
      ...
      <div>
        ...
        <ul>
          <li className='comments mb-4 d-flex align-items-center justify-content-between'>
            <div className='d-flex '>
              <img src={user62x} alt='' className='me-3' />
              <div className='user-info'>
                <div className='d-flex justify-content-between'>
                  <div className='user-details'>
                    <p className='userName m-0'>BoGi</p>
          ...
          <br></br>
          <li className=' comments d-flex align-items-center justify-content-between'>
            <div className='d-flex '>
              <img src={user62x} alt='' className='me-3' />
              <div className='user-info'>
                <div className='d-flex justify-content-between'>
                  <div className='user-details'>
                    <p className='userName m-0'>Elsa</p>
                    <div className='text-muted'>Posted time: 2024/07/09</div>
                  </div>
                </div>
              </div>
